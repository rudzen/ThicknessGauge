...
\include{0_Introduktion}

\include{1_Produktspeks}

\include{2_TeknologiValg}

\include{3_Opstillingen}

\include{Billedfelt_oplsning}
...
\include{5_Resultater}

\include{6_Videre}

\include{Kommandolinje}

\include{Konkludering}
