...
public:
    ...
    Gaussian(const cv::Mat& image, const cv::Size& kernel, double sigmaX, double sigmaY, int border)
        : image_(image)
          , kernel_(kernel)
          , sigmaX_(sigmaX)
          , sigmaY_(sigmaY)
    ...
    Gaussian(const cv::Mat& image, const cv::Size& kernel, double sigmaX, double sigmaY)
        : image_(image)
          , kernel_(kernel)
          , sigmaX_(sigmaX)
          , sigmaY_(sigmaY)
