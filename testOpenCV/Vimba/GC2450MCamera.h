...
#ifndef GC2450MCAMERA_H
#define GC2450MCAMERA_H

#include "VimbaCPP/Include/VimbaCPP.h"
#include <memory>

class GC2450MCamera : public AVT::VmbAPI::Camera, public std::enable_shared_from_this<GC2450MCamera> {
public:
    // to fetch a shared pointer, taking over from the vimba API pointer stuff
    std::shared_ptr<GC2450MCamera> getptr() {
        return shared_from_this();
    }

    typedef SP_DECL( GC2450MCamera ) Ptr;
    ...
    VmbErrorType GetIrisVideoLevelMax(VmbInt64_t& value);
    VmbErrorType SetIrisVideoLevelMax(VmbInt64_t value);
    VmbErrorType GetIrisVideoLevelMaxFeature(AVT::VmbAPI::FeaturePtr& feature);

    VmbErrorType GetIrisVideoLevelMin(VmbInt64_t& value);
    VmbErrorType SetIrisVideoLevelMin(VmbInt64_t value);
    VmbErrorType GetIrisVideoLevelMinFeature(AVT::VmbAPI::FeaturePtr& feature);
...
private:
    ...
    AVT::VmbAPI::FeaturePtr m_IrisVideoLevelMaxFeature;
    AVT::VmbAPI::FeaturePtr m_IrisVideoLevelMinFeature;
